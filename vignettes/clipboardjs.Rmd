...
The goal of `clipboardjs` is to wrap [clipboard.js](http://www.clipboardjs.com) in an easy and low cost way for use in Shiny. You should be able to quickly add buttons or links that copy or cut the contents of other Outputs and server provided items. 
